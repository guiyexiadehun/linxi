...
server.get("/imgList",(req,res)=>{
    var rows=[
        {lid:1,img_url:"http://127.0.0.1:3000/img/index/banner1.png"},
        {lid:2,img_url:"http://127.0.0.1:3000/img/index/banner2.png"},
        {lid:3,img_url:"http://127.0.0.1:3000/img/index/banner3.png"},
        {lid:4,img_url:"http://127.0.0.1:3000/img/index/banner4.png"},
        // {lid:5,img_url:"http://127.0.0.1:3000/img/index/banner5.png"},
        // {lid:6,img_url:"http://127.0.0.1:3000/img/index/banner6.png"},
        {lid:7,img_url:"http://127.0.0.1:3000/img/index/banner7.png"},
        {lid:8,img_url:"http://127.0.0.1:3000/img/index/banner8.png"},
    ];
...
server.get("/grid",(req,res)=>{
    var rows=[
        {lid:1,title:"叫早哄睡",img_url:"http://127.0.0.1:3000/img/grid/menu1.png"},
        {lid:2,title:"排行榜",img_url:"http://127.0.0.1:3000/img/grid/menu2.png"},
        {lid:3,title:"会员",img_url:"http://127.0.0.1:3000/img/grid/menu3.png"},
        {lid:4,title:"分类",img_url:"http://127.0.0.1:3000/img/grid/menu4.png"},
        {lid:5,title:"课程集锦",img_url:"http://127.0.0.1:3000/img/grid/menu5.png"},
        // {lid:6,title:"凯叔小知识",img_url:"http://127.0.0.1:3000/img/grid/menu6.png"}
    ];
    res.send({code:1,data:rows});
})
//功能4：小知识列表
...
server.get("/getMenu",(req,res)=>{
    var rows=[
        {lid:1,title:"训练营",img_url:"http://127.0.0.1:3000/img/course/xly.png"},
        {lid:2,title:"专栏",img_url:"http://127.0.0.1:3000/img/course/zl.png"},
        {lid:3,title:"微课",img_url:"http://127.0.0.1:3000/img/course/wk.png"},
        {lid:4,title:"全部",img_url:"http://127.0.0.1:3000/img/course/all.png"}
    ];
    res.send({code:1,data:rows});
})
